...
public class SwtTable extends GralTable
{
  ...
  /**Version and History:
   * <ul>
   * <li>2011-11-27 Hartmut new {@link #selectionListener}: calls {@link GralTable#actionOnLineSelected(GralTableLine_ifc)}.
    ...
    public void widgetSelected(SelectionEvent ev)
    {
      if(ev.item instanceof TableItem){
        ...
        if(oData instanceof GralTableLine_ifc){
          actionOnLineSelected((GralTableLine_ifc)oData);
        }
