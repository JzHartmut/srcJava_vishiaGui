...
public abstract class GralWidget extends GralWidgetBase implements GralWidget_ifc, GralSetValue_ifc, GetGralWidget_ifc
{
  ...
  public final static class DynamicData {
     ...
     * @return
     */
    public int getChanged(){ return this.whatIsChanged.get(); }
...
//         }
  ...
  @Deprecated @Override public String getName(){
    ...
    else if(this.sDataPath !=null) return this.sDataPath;
    else if(this.sCmd !=null) return this.sCmd;
   ...
   * */
  public void setContentInfo(Object content){  this.oContentInfo = content;}

  /**Gets the application specific info. See {@link #setContentInfo(Object)}.
   * @deprecated use {@link #getData()}
   */
  public Object getContentInfo(){ return this.oContentInfo; }
   ...
   * It should help to present user data which are associated to this widget.
   * This info can be set and changed anytime. */
  public void setData(Object data){  this.oContentInfo = data;}

  /**Gets the application specific info. See {@link #setData(Object)}. */
  public Object getData(){ return this.oContentInfo; }
  ...
  @Override public void setEditable(boolean editable){
    if(this.bEditable != editable) {
      ...
      this.dyda.setChanged(ImplAccess.chgEditable);
      redraw(this.redrawtDelay, this.redrawDelayMax);
    }
  }

  @Override public boolean isEditable(){ return this.bEditable; }


  @Override public boolean isNotEditableOrShouldInitialize(){ return !this.bEditable || this.bShouldInitialize; }
  ...
  public String getCmd(){ return this.sCmd; }
  ...
  public String getCmd(int option){
    int pos1 = this.sCmd.indexOf('[');
    int pos2 = this.sCmd.indexOf(']', pos1+1);
    if(pos1 >=0 && pos2 > pos1){
      String sBase = this.sCmd.substring(0, pos1);
      String sEnd = this.sCmd.substring(pos2+1);  //maybe ""
      String[] sOptions = this.sCmd.substring(pos1+1, pos2).split("\\|");
  ...
  @Override public void setCmd(String cmd){ this.sCmd = cmd; }
  ...
  public void specifyActionChange(String sAction, GralUserAction action, String[] args, ActionChangeWhen... when){
    ...
    if(when.length==0){
      this.cfg.actionChange1 = action1;
      this.cfg.actionChangeSelect = null;
      this.cfg.actionChange1When = null;
    } else if(this.cfg.actionChange1 == null && this.cfg.actionChangeSelect == null) {
      //first invocation, only one action but for special operations (when)
      this.cfg.actionChange1 = action1;
      this.cfg.actionChangeSelect = null;
      this.cfg.actionChange1When = when;
    } else {
      if(this.cfg.actionChangeSelect == null) { this.cfg.actionChangeSelect = new ActionChangeSelect(); }
      if(this.cfg.actionChange1 !=null) { //given
        ActionChangeWhen[] whenGiven = this.cfg.actionChange1When == null ? whenAll : this.cfg.actionChange1When;
        for(ActionChangeWhen when1: whenGiven) {
          specifyActionChangeWhen(this.cfg.actionChange1, when1);
        }
  ...
  {
    switch(when){
    case onAnyChgContent: this.cfg.actionChangeSelect.onAnyChangeContent = action; break;
    case onAnyKey: this.cfg.actionChangeSelect.onAnyKey = action; break;
    case onCtrlEnter: this.cfg.actionChangeSelect.onCtrlEnter = action; break;
    case onFocusGained: this.cfg.actionChangeSelect.onFocusGained = action; break;
    case onChangeAndFocusLost: this.cfg.actionChangeSelect.onChangeAndFocusLost = action; break;
    case onDrag: this.cfg.actionChangeSelect.onDrag = action; break;
    case onDrop:this.cfg.actionChangeSelect.onDrop = action;  break;
    case onEnter: this.cfg.actionChangeSelect.onEnter = action; break;
    case onMouse1Double: this.cfg.actionChangeSelect.onMouse1Double = action; break;
    case onMouse1Dn: this.cfg.actionChangeSelect.onMouse1Dn = action; break;
    case onMouse1Up: this.cfg.actionChangeSelect.onMouse1Up = action; break;
    case onMouse1UpOutside: this.cfg.actionChangeSelect.onMouse1UpOutside = action; break;
    case onMouse2Up: this.cfg.actionChangeSelect.onMouse2Up = action; break;
    case onMouseWheel: this.cfg.actionChangeSelect.onMouseWheel = action; break;
...
//    else { } //TODO set to instanciation data
  ...
  public ActionChange getActionChangeStrict(ActionChangeWhen when, boolean strict) {
    if(this.cfg.actionChange1 !=null) {
      ...
      if(when == null || this.cfg.actionChangeSelect == null) return null;
      switch(when){
  ...
  public void setActionMouse(GralMouseWidgetAction_ifc mouseWidgetAction, int mUser){
    this.cfg.mouseWidgetAction = mouseWidgetAction;
    this.cfg.mMouseToActionChange = mUser;
  }
   ...
   */
  public void setActionShow(GralUserAction action, String[] param){ this.cfg.actionShow = action; this.cfg.sShowParam = param; }
   ...
   */
  public GralUserAction getActionShow(){ return this.cfg.actionShow; }

  public void setActionFocused(GralUserAction action){ this.cfg.actionFocused = action; }

  public GralUserAction getActionFocused(){ return this.cfg.actionFocused; }
  ...
  {
    this.cfg.actionDrag = action;
    if(this._wdgImpl !=null) this._wdgImpl.setDragEnable(dragType);  // call implementation specific drop handling.
  }

  public GralUserAction getActionDrag(){ return this.cfg.actionDrag; }
  ...
  {
    this.cfg.actionDrop = action;
    if(this._wdgImpl !=null) this._wdgImpl.setDropEnable(dropType);  // call implementation specific drop handling.
  }

  public GralUserAction getActionDrop(){ return this.cfg.actionDrop; }
  ...
  public int getDataIx(){ return this.dataIx; }
   ...
   * @return
   */
  public String[] getShowParam(){ return this.cfg.sShowParam; }

  /**Clear the parameter if they are over-taken already.
  */
  public void clearShowParam(){ this.cfg.sShowParam = null; }
   ...
   *
   */
  public void setHtmlHelp(String url){ this.htmlHelp = url; }

  public String getHtmlHelp(){ return this.htmlHelp; }
  ...
  @Deprecated public VariableAccess_ifc getVariableFromContentInfo(VariableContainer_ifc container)
  {
    ...
    if(oContentInfo == null){
      ...
      if(sPath1 !=null && (sPath1 = sPath1.trim()).length()>0){
        String sPath = this.gralMng.getReplacerAlias().replaceDataPathPrefix(sPath1);
  ...
  public VariableAccess_ifc getVariable(VariableContainer_ifc container) {
    ...
    if(this.variable ==null && this.variables == null && this.sDataPath !=null && !this.sDataPath.startsWith("#")){ //no variable known, get it.
      if(this.sDataPath.contains(",")){
        String[] sDataPaths = this.sDataPath.split(",");
        this.variables = new LinkedList<VariableAccess_ifc>();
        for(String sPath1: sDataPaths){
          if(sPath1.contains("["))
            stop();
          String sPath2 = sPath1.trim();
          String sPath = this.gralMng.getReplacerAlias().replaceDataPathPrefix(sPath2);
        ...
        if(this.sDataPath.contains("["))
          stop();
        String sPath2 = this.sDataPath.trim();
        String sPath = this.gralMng.getReplacerAlias().replaceDataPathPrefix(sPath2);
        this.variable = container.getVariable(sPath);
      }
    }
    if(this.variable !=null) return this.variable;
    if(this.variables !=null && this.variables.size() >0) return this.variables.get(0);
    else return null;
  }
  ...
  @Override public void refreshFromVariable(VariableContainer_ifc container
    ...
    if(this.sDataPath ==null) return;
    if(this.sDataPath !=null && this.sDataPath.startsWith("intern"))
      stop();
    if(this instanceof GralLed)
      stop();
    //
    if(this.dyda.bTouchedField) return; //do not modify if it is actually touching.
    ...
    if(this.cfg.actionShow !=null){
      ...
      if(!this.cfg.actionShow.exec(0, this, this.variable !=null ? this.variable : this.variables)){
      ...
      if(this.variable !=null){
        ...
        if(colorRefreshed !=null && colorOld !=null){
          long timeVariable = this.variable.getLastRefreshTime();
        ...
        char cType = this.variable.getType();
        String sValue = null;
        switch(cType){
          case 'Z': case 'S': case 'B':
          case 'I': setLongValue(this.variable.getInt()); break;
          case 'L': setLongValue(this.variable.getLong()); break;
          case 'F': setValue(this.variable.getFloat()); break;
          case 'D':
            Object[] value = new Double[1];
            value[0] = new Double(this.variable.getDouble());
            setValue(value);
            break;
          case 's': setText(this.variable.getString()); break;
        ...
        if(this.variables.size() == 0){ this.variables = null; }
        else {
          Object[] values = new Object[this.variables.size()];
          int ixVal = -1;
          for(VariableAccess_ifc variable1: this.variables){
            char cType = variable1.getType();
            switch(cType){
              case 'Z': case 'S': case 'B':
                case 'I': values[++ixVal] = variable1.getInt(); break;
              case 'L': setValue(this.variable.getFloat()); break;
      ...
      } else if(this.sDataPath !=null){
        setText("?? " + this.sDataPath); //called on fault variable path.
  ...
  public void requestNewValueForVariable(long timeRequested){
    if(this.variable !=null){ this.variable.requestValue(timeRequested); }
    else if(this.variables !=null){
      for(VariableAccess_ifc variable1: this.variables){
  ...
  @Override public boolean setVisible ( boolean visible){
    ...
    String nameParent = this._wdgPos.parent == null ? "main window" : this._wdgPos.parent.getName();
    if(visible) {
...
//      this.gralMng.log.sendMsg(GralMng.LogMsg.setInvisible , "GralWidget set invisible: %s@%s (%s)", this.name, nameParent, toString());
    ...
    if(this instanceof GralWindow)
      Debugutil.stop();
    this.bVisibleState = visible;  //without graphic yet now
    if(this._wdgImpl != null) {
      if(this.gralMng.currThreadIsGraphic()) {
        this._wdgImpl.setVisibleGThread(visible);   //sets the implementation widget visible.
      } else {
        this.dyda.setChanged(visible ? ImplAccess.chgVisible : ImplAccess.chgInvisible);
        redraw(-this.redrawtDelay, this.redrawDelayMax);
      }
    }
  ...
  @Override public boolean isChanged(boolean setUnchanged){
    boolean bChanged = this.dyda.bTextChanged;
    if(setUnchanged){
  ...
  { this.dyda.visibleInfo = visibleInfo;
    this.dyda.setChanged(ImplAccess.chgVisibleInfo);
    redraw(this.redrawtDelay, this.redrawDelayMax);
  ...
  @Override public void setBackColor(GralColor color, int ix){
    if(this.dyda.backColor == null || color.notUsed() || !this.dyda.backColor.equals(color)){
      this.dyda.backColor = color;
  ...
  @Override public void setLineColor(GralColor color, int ix){
    if(this.dyda.lineColor == null || !this.dyda.lineColor.equals(color)){
      this.dyda.lineColor = color;
      this.dyda.setChanged(ImplAccess.chgColorLine);
      redraw(this.redrawtDelay, this.redrawDelayMax);
    }
  }

  @Override public void setTextColor(GralColor color){
    if(this.dyda.textColor == null || !this.dyda.textColor.equals(color)){
      this.dyda.textColor = color;
      this.dyda.setChanged(ImplAccess.chgColorText);
      redraw(this.redrawtDelay, this.redrawDelayMax);
    }
  }
  ...
  @Override public void setLongValue(long value){
    this.dyda.fValue = value; //may be shorten in acceleration
    this.dyda.lValue = value;
    redraw(this.redrawtDelay, this.redrawDelayMax);
    //itsMng.setInfo(this, GralMng_ifc.cmdSet, 0, value, null);
  }
   ...
   */
  public float getFloatValue(){ return this.dyda.fValue; }


  /**Gets the float attribute value of this widget. Returns 0.0 if a float value is never used.
   */
  public float getLongValue(){ return this.dyda.lValue; }
  ...
  @Override public void setText(CharSequence text){
    this.dyda.displayedText = text.toString();
   ...
   */
  public String getText(){ return this.dyda.displayedText == null? "" : this.dyda.displayedText; }
  ...
  @Override public void setMinMax(float minValue, float maxValue){
    this.dyda.minValue = minValue;
    this.dyda.maxValue = maxValue;
    redraw(this.redrawtDelay, this.redrawDelayMax);
    //
  }


  @Override public long setContentIdent(long date){ long last = this.dateUser; this.dateUser = date; return last; }

  @Override public long getContentIdent(){ return this.dateUser; }
...
//    this.gralMng.log.sendMsg(GralMng.LogMsg.setFocus, "GralWidget.setFocus: " + delay +" §" + this.name);
   ...
   * @return The panel.
   */
  public GralPanelContent getItsPanel(){ return (GralPanelContent)this._wdgPos.parent; }
  ...
  public void redraw ( int delay, int latest, boolean onlyDynamics ){
    if(this.gralMng !=null && this.gralMng._mngImpl !=null && this._wdgImpl!=null ) { //NOTE: set of changes is possible before setToPanel was called.
      this._wdgImpl.bRedrawOnlyDynamics = onlyDynamics;
      if(delay <= 0 && this.gralMng.currThreadIsGraphic() && this._wdgImpl !=null){
        this._wdgImpl.redrawGthread();
      } else {
        long time = System.currentTimeMillis();
        this.redrawRequ.setStackInfo();
        this.redrawRequ.timeOrder.activateAt(time + Math.abs(delay), latest ==0 ? 0 : time + latest);
      }
    }
  }
  ...
  @Override public Appendable toString(Appendable u, String ... cond) {
    try {
      ...
      if(this.sDataPath !=null) { u.append(", data=").append(this.sDataPath);}
  ...
  public abstract static class ImplAccess implements GralWidgImplAccess_ifc {
    ...
    public final void XXXfocusGained(){
      ...
      if(this.widgg.cfg.actionFocused !=null){ this.widgg.cfg.actionFocused.exec(KeyCode.focusGained, this.widgg); }
...
//      this.widgg.gralMng.log.sendMsg(GralMng.LogMsg.setVisibleFromImpl, "set visible from Impl = " + (visible? "true" : "false") + this.widgg.toString());
      this.widgg.bVisibleState = visible;
    }

    /**Access method to GralWidget's method. */
    protected final GralUserAction actionShow(){ return this.widgg.cfg.actionShow; }
    ...
    protected final GralWidget.DynamicData dyda(){ return this.widgg.dyda; }
    ...
    protected final void setTextChanged(){ this.widgg.dyda.bTextChanged = true; }
     ...
     * @return
     */
    protected final int getChanged(){ return this.widgg.dyda.whatIsChanged.get(); }

    protected final void acknChanged(int mask){ this.widgg.dyda.acknChanged(mask); }


    protected final ActionChange getActionChange(ActionChangeWhen when){ return this.widgg.getActionChange(when); }
   ...
   */
  public ImplAccess getImplAccess(){ return this._wdgImpl; }
...
//      this.gralMng.log.sendMsg(GralMng.LogMsg.evRedraw, "redraw " + super.sInfo);
  ...
  { if(this._wdgImpl !=null) this._wdgImpl.setBoundsPixel(x, y, dx, dy);
  }
  ...
  { if(this._wdgImpl !=null) return this._wdgImpl.getWidgetImplementation();
    else return null;
  }
  ...
  { if(this._wdgImpl !=null) this._wdgImpl.removeWidgetImplementation();
  }
  ...
  {
    if(this._wdgImpl !=null) this._wdgImpl.redrawGthread();
  }
  ...
  { boolean ret;
    try{
      if(this._wdgImpl !=null) {
        ret = this._wdgImpl.setFocusGThread();
        this.bVisibleState = true;  //may be set via the _wdgImpl too, but set additional if not done in _wdgImpl.setFocusGThread()
      }
      else ret = false;
    } catch(Exception exc){
