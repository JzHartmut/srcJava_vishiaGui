 ...
 *   of {@link org.vishia.gral.base.GralGraphicOrder} in the central queue of requests using 
 *   {@link org.vishia.gral.base.GralGraphicThread#addDispatchOrder(org.vishia.gral.base.GralGraphicOrder)}. 
 ...
 *   {@link org.vishia.gral.base.GralGraphicOrder}. Any of them may have a specific delay. 
 *   The graphic thread organizes it in a proper kind of time.
 * <li>If a {@link org.vishia.gral.base.GralGraphicOrder} is dequeued in the graphic thread, 
 *   its method {@link org.vishia.gral.base.GralGraphicOrder#executeOrder(boolean)} is invoked. 
...
public interface GralWidget_ifc extends GralWidgetBase_ifc
{
   ...
   * in the {@link GralGraphicThread#addTimeEntry(GralGraphicOrder)}. In the requested time that 
   ...
   * <br><br>
   * If more as one attribute is changed one after another, only one instance of the {@link GralGraphicOrder}
