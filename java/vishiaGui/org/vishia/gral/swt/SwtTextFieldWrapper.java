...
public class SwtTextFieldWrapper extends GralTextField.GraphicImplAccess
{
  ...
  private SwtTextFieldWrapper(GralTextField widgg, SwtMng swtMng, boolean bbox)
  {
    ...
    int wborder = this.textFieldSwt.getBorderWidth();
    //textFieldSwt.setBounds(boundsField.x, boundsField.y, boundsField.dx, boundsField.dy);
    Font textFont = swtMng.propertiesGuiSwt.stdInputFont;
    textFieldSwt.setFont(textFont);
    this.widgg._fontId = textFont.hashCode();
  ...
  */
  ...
  @Override public void setBoundsPixel(int x, int y, int dx, int dy) { 
    ...
    if(this.posPrompt ==null) {
      this.textFieldSwt.setBounds(x-1,y-2,dx+2,dy+4);  // without border it's the correct bounds
      ...
      this.textFieldSwt.setBounds(x-1, y-2, dx+2, dy+4);
    }
  }
